    ...
    <ImageBackground
      ...
      <ScrollView>
        ...
        <Accordion
          ...
          Detail="معاشرے میں دن بدن بڑھتے ہوئے کرائم بچوں کے تحفظ کے بارے میں والدین کو بہت پریشان کرتے کو تعلیم کی بجائے ضیائع وقت کا سبب بنے نے ہیں بہت بڑا طبقہ اپنے بچوں کو اپنے گھر میں ہی دینی تعلیم سے بنتے ہیں اکیڈمی نے ملک بھر سے اسائندہ کا ڈیٹا کلیکٹ کرنا شروع سے تعلیمی معیار اور ذمہ استاد والدین اور بچوں کے لیے حصول دین کا ذریعہ بنیں گے کرائم والدین کو اپنے بے غیر معیاری تعلیم اور غیر ذمہ دار افراد بچوں کو لے و ٹیچر آپ کے بچوں کو ڈور اسٹیپ پر تعلیم دیں گے جس سے تعلیمی معاشرے میں دن بدن بڑھتے ہوئے آراستہ کرنا چاہتا ہے ، لیکن نج کر دیا عنقریب سینئر ، ماہر با اعتماد نیچر آ"
          openAccordion={openAccordion}
          onToggle={handleToggle}
        />
        <Accordion
          id={4}
          title=" ازہار الاسلام ٹیوشن نیٹورک (آف لائن)"
          Detail="نے بچوں کے تحفظ کے بارے میں بہت پریشان کرتے
          کو تعلیم کی بجائے ضیائع وقت کا سبب بنے
          نے ہیں بہت بڑا طبقہ اپنے بچوں کو اپنے گھر میں ہی دینی تعلیم سے
          بنتے ہیں اکیڈمی نے ملک بھر سے اسائندہ کا ڈیٹا کلیکٹ کرنا شروع
          سے تعلیمی معیار اور ذمہ استاد والدین اور بچوں کے لیے حصول دین کا ذریعہ بنیں گے
          کرائم والدین کو اپنے بے
          غیر معیاری تعلیم اور غیر ذمہ دار افراد بچوں کو لے
          و ٹیچر آپ کے بچوں کو ڈور اسٹیپ پر تعلیم دیں گے جس سے تعلیمی
          معاشرے میں دن بدن بڑھتے ہوئے
          آراستہ کرنا چاہتا ہے ، لیکن نج
          کر دیا عنقریب سینئر ، ماہر با اعتماد نیچر آ"
          openAccordion={openAccordion}
          onToggle={handleToggle}
        />
      </ScrollView>
