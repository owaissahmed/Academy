    ...
    <ImageBackground
      ...
      <ScrollView>
        ...
        <Accordion
          ...
          Detail="ملک و بیرون ملک کے شائقین علم طلبہ کے لیے باقاعدہ درس نظامی کا اغاز کر دیا گیا جس میں کنز المدارس پاکستان کے نصاب کے مطابق 8 سالہ عالم کورس کروایا جائے
          گا، ممکنہ حد تک کنزالمدارس سے پیپر بھی دلوائے جائیں گے اور اکیڈمی اپنی سند کااجراء بھی کرے گی    ان شاء الله"
          openAccordion={openAccordion}
          onToggle={handleToggle}
        />
        <Accordion
          ...
          Detail="تشنگان علم کی سیرابی کے لیے ازھار الاسلام اکیڈمی نے آن لائن پر سہیل ٹیوشن سینٹر کا انعقاد کیا جس میں طلبہ اپنے اسباق اپنے ہم ذہن ٹیوٹر سے اپنی مرضی کے اوقات میں مکمل
