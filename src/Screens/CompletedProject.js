  ...
  return (
    <ImageBackground
      ...
      <Animatable.View animation={'fadeInUp'} delay={100} duration={2000}>
        ...
        کے نتیجے میں وہ تعلیم سے محروم رہ جاتی ہے حالانکہ نسل نو کی تعمیر کی پہلی ذمہ داری انہی خواتین پر ہوتی ہے اسی لیے اکیڈمی نے ازہار الاسلام اکیڈمی للبنات (آف لائن) کا آغاز کر دیا گیا ہے ، ان شاء اللہ مختلف شہروں اور ملکوں میں اس کی برانچز کا سلسلہ ہو گا جہاں ناظرہ ، حفظ ، درس نظامی کے ساتھ ساتھ اکیڈمی میں چلنے والے والے آن لائن شارٹ
